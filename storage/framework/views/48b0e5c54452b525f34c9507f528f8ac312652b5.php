    ...
    <section class=" p-10 my-10 border rounded-lg">
        <div class="row">
            <div class="col-12 col-lg-4">
                <?php if(
                    $user->id != $assignment->teacher_id and $user->id != $assignment->creator_id and
                    (
                ...
                <?php else: ?>
                    <div class="bg-info-light p-10 rounded-sm border">
                        <h4 class="font-16 font-weight-bold text-dark-blue">
                            <?php if($user->id == $assignment->teacher_id or $user->id == $assignment->creator_id): ?>
                        ...
                        <form method="post" action="/course/assignment/<?php echo e($assignment->id); ?>/history/<?php echo e($assignmentHistory->id); ?>/message">
                            ...
                            <?php if($user->id == $assignment->teacher_id): ?>
...
<?php /**PATH C:\Users\fuads\OneDrive\Desktop\Laravel\academy.mhis.link\resources\views/web/default/course/learningPage/components/assignment.blade.php ENDPATH**/ ?>