...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 <?php if(!empty($authUser->userGroup)): ?> has-user-group <?php endif; ?> <?php if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])): ?> without-bottom-image <?php endif; ?>" <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <?php if(!$authUser->isUser()): ?>
            <li class="sidenav-item <?php echo e((request()->is('panel/report*')) ? 'sidenav-item-active' : ''); ?>">
                ...
                <div class="collapse <?php echo e((request()->is('panel/report') or request()->is('panel/report*')) ? 'show' : ''); ?>" id="reportCollapse">
                    <ul class="sidenav-item-collapse">
                            <li class="mt-5 <?php echo e((request()->is('panel/report/user')) ? 'active' : ''); ?>">
                                <a href="/panel/report/user">Report User</a>
                            </li>
                            <li class="mt-5 <?php echo e((request()->is('panel/report/division')) ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\fuads\OneDrive\Desktop\Laravel\academy.mhis.link\resources\views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>