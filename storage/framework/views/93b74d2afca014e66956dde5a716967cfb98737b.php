    ...
    <section class="mt-25">
        <form action="" method="get">
            <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
                ...
                <div class="form-group d-flex align-items-center m-0 w-50 p-3">
                    <input type="text" name="q" value="<?php echo e($q); ?>" class="form-control border-0" placeholder="<?php echo e(trans('home.slider_search_placeholder')); ?>"/>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fuads\OneDrive\Desktop\Laravel\academy.mhis.link\resources\views/web/default/panel/webinar/index.blade.php ENDPATH**/ ?>