            ...
            <form id="form-filter">
                        ...
                        <div class="form-group">
                            ...
                            <select name="division" id="division" class="form-control select2" style="width: 100%">
                                <?php $__currentLoopData = $divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($division->id); ?>"><?php echo e($division->slug); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                ...
                <div class="row">
                    <div class="col-12 col-lg-3 d-flex justity-content-end">
                        <button type="button" onclick="getData()" class="btn btn-sm btn-primary w-100 mt-2"><?php echo e(trans('public.show_results')); ?></button>
                    </div>
                </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fuads\OneDrive\Desktop\Laravel\academy.mhis.link\resources\views/web/default/panel/report/division-report.blade.php ENDPATH**/ ?>