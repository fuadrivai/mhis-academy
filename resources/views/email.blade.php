...
<body style="color:#444; font-family:Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif; font-size:14px; line-height:1.5; margin:0">
	<table class="wrapper-table" cellpadding="5" cellspacing="0" width="100%" border="0" style="border-collapse:collapse; font-size:14px; line-height:1.5; background-color:#fff; background-repeat:no-repeat; background-position:left top" bgcolor="#ffffff">
		<tbody>
											...
											<tr style="border-color:transparent">
												<th width="600" style="border-color:transparent; font-weight:400; text-align:left; vertical-align:top" cellpadding="0" cellspacing="0" class="tc" align="left" valign="top">
														...
														<tbody>
															<tr style="border-color:transparent">
																<td cellpadding="0" cellspacing="0" style="border-collapse:collapse; border-color:transparent">
																	<table width="100%" cellpadding="0" cellspacing="0"id="wout_block_4_element_0" style="border-collapse:collapse; font-size:14px; line-height:1.5">
																		<tbody>
																			<tr class="content-row" style="border-color:transparent; color:#444; font-family:Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif">
																				<td class="content-cell padding-lr-0 padding-top-0 padding-bottom-0" width="600" style="border-collapse:collapse; border-color:transparent; vertical-align:top; padding-left:0; padding-right:0; padding-top:0; padding-bottom:0" valign="top">
																					<div id="wout_block_4_element_0" style="font-size:14px; line-height:1.5; width:100%; height:183; display:block" width="100%" height="183">
																						<a target="_blank"rel="noopener noreferrer"class="link_img" href="" style="text-decoration:none; color:#0089bf; display:block"><img
																								border="0" width="600"
																								height="auto"
																								class=" sp-img "
																								align="left"
																								alt="Assalamu’alaykum warahmatullahi wabarakatuh, Dear parents, thank you for your interest in our school."
																								src="https://mutiaraharapan.sch.id/wp-content/uploads/2020/01/logo_mh_all_level_220_x_67_cm-01.png"
																								iout_block_4_element_0=""
																								style="height:auto; line-height:100%; outline:0; text-decoration:none; border:0; margin:0; display:block; -ms-interpolation-mode:bicubic"></a>
																					</div>
																					<div
													...
													<table border="0" width="100%" cellpadding="0" cellspacing="0"
														style="border-collapse:collapse; font-size:14px; line-height:1.5; background-color:#fff"
														bgcolor="#ffffff">
														<tbody>
															<tr style="border-color:transparent">
																<td cellpadding="0" cellspacing="0"
																	...
																	<table width="100%" cellpadding="0" cellspacing="0"
																		...
																		style="border-collapse:collapse; font-size:14px; line-height:1.5; text-color:black; font-weight:normal; margin:0">
																		<tbody>
																			<tr class="content-row"
																				...
																				<td class="content-cell padding-bottom-0"
																					...
																					valign="top">
																					<p style="line-height:inherit; margin:0 0 10px; font-size:inherit; color:inherit; font-family:Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif; text-align:justify; font-weight:normal; padding:0"
																						align="justify">
																						<span
																							style="font-weight: 400;">Assalamualaikum
																							warahmatullahi
																							wabarakatuh,</span>
																					</p>
																					<p style="line-height:inherit; margin:0 0 10px; font-size:inherit; color:inherit; font-family:Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif; text-align:justify; font-weight:normal; padding:0"
																						align="justify">
																						<span
																							style="font-weight: 400;">Dear
																							Teachers, Attached Course Statistics Report, 
																							please click the button below to view more. 
																						</span>
																					</p>
																					<div
																						style="font-size:14px; line-height:1.5; clear:both">
																				...
																				<td class="content-cell" width="570"
																					...
																					<center>
																						<table cellpadding="0"
																							...
																							style="border-collapse:collapse; font-size:14px; line-height:1.5; border:0; margin-left:auto; margin-right:auto; width:auto !important; border-radius:5px; box-shadow:none; background:#29b590"
																												...
																												<tr
																													...
																													<td align="center"
																														...
																														<a target="_blank"
																															...
																															style="text-decoration:none; color:#FFF; display:block; padding:12px 18px; font-family:Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif; font-family-short:arial; font-size:16px; font-weight:bold"
																															href="https://academy.mhis.link/pdf/view/{{$email}}">Click Me</a>
																													</td>
																												</tr>
																											</tbody>
																										</table>
										...
										<tbody>
											<tr style="border-color:transparent">
												<th width="600"
													...
													cellpadding="0" cellspacing="0" class="tc" align="left"
													valign="top">
													<table border="0" width="100%" cellpadding="0" cellspacing="0"
														...
														<tbody>
															<tr style="border-color:transparent">
																<td cellpadding="0" cellspacing="0"
																	style="border-collapse:collapse; border-color:transparent">
																	<table width="100%" cellpadding="0" cellspacing="0"
																		style="border-collapse:collapse; font-size:14px; line-height:1.5; size:32px; order:1; text-align:center"
																		align="center">
																		<tbody>
																			<tr class="content-row"
																				style="border-color:transparent; color:#444; font-family:Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif">
																						...
																						<tbody>
																							<tr
																								...
																								<th class="social_element social_element_h_i"
																									...
																									<a target="_blank"
																										rel="noopener noreferrer"
																										href="https://www.facebook.com/mutiaraharapanislamicschool/"
																										style="text-decoration:none; color:#0089bf"><img
																											border="0"
																											alt="Facebook"
																											...
																											width="32"
																											height="auto"
																											src="https://s7768615.sendpul.se/img/constructor/social/round/facebook.png"></a>
																								</th>
																								<th class="social_element social_element_h_i"
																									style="border-color:transparent; padding:2px 5px; font-size:13px; font-family:Arial, sans-serif; line-height:32px; font-weight:400; text-align:left; border-width:0; border-style:none; border:0"
																									align="left">
																									<a target="_blank"
																										rel="noopener noreferrer"
																										href="https://www.instagram.com/mutiara_harapan_islamic_school/?hl=en"
																										style="text-decoration:none; color:#0089bf"><img
																											border="0"
																											alt="Instagram"
																											class="social small_img smallImg"
																											...
																											width="32"
																											height="auto"
																											src="https://s7768615.sendpul.se/img/constructor/social/round/instagram.png"></a>
																								</th>
																								<th class="social_element social_element_h_i"
																									style="border-color:transparent; padding:2px 5px; font-size:13px; font-family:Arial, sans-serif; line-height:32px; font-weight:400; text-align:left; border-width:0; border-style:none; border:0"
																									align="left">
																									<a target="_blank"
																										rel="noopener noreferrer"
																										href="https://www.youtube.com/channel/UCQF7LfijHASD7dHwHK_88gw"
																										style="text-decoration:none; color:#0089bf"><img
																											border="0"
																											alt="YouTube"
																											class="social small_img smallImg"
																											...
																											width="32"
																											height="auto"
																											src="https://s7768615.sendpul.se/img/constructor/social/round/youtube.png"></a>
																								</th>
																							</tr>
																						</tbody>
																					</table>
