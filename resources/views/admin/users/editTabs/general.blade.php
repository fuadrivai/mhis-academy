            ...
            <form action="{{ getAdminPanelUrl() }}/users/{{ $user->id .'/update' }}" method="Post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('role_id') is-invalid @enderror" id="roleId" name="role_id">
                        <option disabled {{ empty($user->role_id ) ? 'selected' : '' }}>{{ trans('admin/main.select_role') }}</option>
                ...
                <div class="form-group">
                    <label>{{ trans('/admin/main.user_category') }}</label>
                    <select class="form-control @error('category_id') is-invalid @enderror" id="categoryId" name="category_id">
                        <option disabled {{ empty($user->category_id) ? 'selected' : '' }}>{{ trans('admin/main.select_category') }}</option>
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" {{ (!empty($user) and $user->category_id == $category->id) ? 'selected' :''}}>{{ $category->slug }}</option>
                        @endforeach
                    </select>
                    @error('category_id')
                    <div class="invalid-feedback">
