                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <form action="{{ getAdminPanelUrl() }}/users/store" method="Post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 @error('category_id') is-invalid @enderror" id="categoryId" name="category_id">
                                                <option disabled selected>{{ trans('admin/main.select_category') }}</option>
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" {{ old('category_id') === $category->id ? 'selected' :''}}>{{ $category->slug }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                            <div class="invalid-feedback">
